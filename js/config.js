...
window.CONFIG = {
  ...
  ILLUSTRATIONS: {
    ...
    galleryBanner: 'assets/illustrations/customize-banner.png',
    customizeBanner: 'assets/illustrations/customize-banner.png',
  ...
  STRINGS: {
    en: {
      ...
      playArea: 'Character click area',
      gameControls: 'Game actions',
      locked: 'LOCKED',
      ...
      customize: 'LOOK',
      customizeTitle: 'Choose your look',
      customizeHint: 'Character + scenery',
      customizeManual: 'Scene: {a}',
      customizeModels: 'CHARACTER',
      customizeScenes: 'SCENERY',
      customizeModelTab: 'Choose character',
      customizeSceneTab: 'Choose scenery',
      customizeControls: 'Choose character or scenery',
      gallery: 'COLLECTION',
      ...
      galleryBannerAlt: 'Cosmic style picker',
    ...
    ru: {
      ...
      playArea: 'Область клика по персонажу',
      gameControls: 'Игровые действия',
      locked: 'ЗАКРЫТО',
      ...
      customize: 'ОБРАЗ',
      customizeTitle: 'Выбери свой образ',
      customizeHint: 'Персонаж + сцена',
      customizeManual: 'Сцена: {a}',
      customizeModels: 'ПЕРСОНАЖ',
      customizeScenes: 'СЦЕНА',
      customizeModelTab: 'Выбрать персонажа',
      customizeSceneTab: 'Выбрать сцену',
      customizeControls: 'Выбрать персонажа или сцену',
      gallery: 'ГАЛЕРЕЯ',
      ...
      galleryBannerAlt: 'Космический выбор образа',
